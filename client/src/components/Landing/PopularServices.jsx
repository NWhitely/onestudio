...
function PopularServices() {
  ...
  const popularServicesData = [
    { name: "BOW DOWN TO THE EULE", label: "She's a hungry cat", image: "/service1.jpg" },
    { name: "PET THE EULE", label: "She wants pets", image: "/service2.jpeg" },
    { name: "SEE THE QUEEN", label: "She is the majesty", image: "/service3.jpeg" },
    { name: "SAY HELLO TO THE EULE", label: "She demands hellos", image: "/service4.jpg" },
    { name: "SUBSCRIBE TO EULE'S ONLY FANS", label: "She doesn't actually have one", image: "/service5.jpg" },
...
export default PopularServices;
  ...
  //3.11.25 Modified to reflect sizes and priority